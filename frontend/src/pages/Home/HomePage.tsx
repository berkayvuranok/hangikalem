    ...
    <div>
      ...
      <Reveal>
        <section className="mx-auto max-w-6xl px-4 py-16">
          <SectionHeading
            eyebrow="Katalog"
            title="Tüm katalog burada"
            body={catalogTotal ? `${catalogTotal} model. Keşif sayfasındaki her kalem aynı katalogdan.` : 'Keşif sayfasındaki her model aynı katalogdan geliyor.'}
          />
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
